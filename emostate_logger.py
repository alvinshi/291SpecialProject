...
IEE_EmoEngineEventCreate.argtypes = [] # Takes no argument
IEE_EmoEngineEventCreate.restype = c_void_p # Returns void *
eEvent = IEE_EmoEngineEventCreate() # eEvent is EmoEngineEventHandle
                                    # Used to retrieve events

IEE_EmoStateCreate = libEDK.IEE_EmoStateCreate
IEE_EmoStateCreate.restype = c_void_p
eState = IEE_EmoStateCreate() # eStste is EmoStateHandle
                              # stores an EmoState
...
IEE_EmoEngineEventGetEmoState.argtypes = [c_void_p, c_void_p]
                                    # EmoEngineEventHandle and EmoStateHandle
...
def logEmoState(userID, eState):
    ...
    # print upperFaceAction
    print lowerFaceAction
    print lowerFacePower
    ...
    # Gets what mental command is being conveyed.. But always neutral.
...
option = c_int(0)
state  = c_int(0)
# composerPort = c_uint(1726) EmoComposer
composerPort = c_uint(3008)
